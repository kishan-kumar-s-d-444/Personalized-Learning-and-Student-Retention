            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box component="main" sx={styles.boxStyled}>
                    ...
                    <Routes>
                        ...
                        <Route path="/Student/courserec" element={<Courserec/>} />
                        <Route path="Student/course" element={<StudentCourse/>}/>
                        <Route path="/Student/doubt" element={<StudentDoubt/>}/>
                        
                        <Route path="/Student/assign" element={<Assign/>}/>
                        <Route path="/Student/quiz" element={<Quizz/>}/>
                        <Route path="/Student/videos" element={<Videos/>}/>
                        <Route path="/Student/query" element={<Query/>}/>
                        <Route path="/Student/dict" element={<Dict/>}/>
